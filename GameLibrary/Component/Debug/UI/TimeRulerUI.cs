...
namespace GameLibrary.Component.Debug.UI
{
    /// <summary>
    ...
    /// 
    /// </remarks>
    public class TimeRulerUI : DrawableGameComponent
    {
        #region Constants
        ...
        public TimeRulerUI(Game game)
            : base(game)
        {
            // Add this as a service.
            Game.Services.AddService(typeof(TimeRulerUI), this);
        }
        ...
        protected override void LoadContent()
        {
            ...
            //position = layout.Place(new Vector2(Width, BarHeight), 0, 0.01f, Alignment.TopRight);
        ...
        public void StartFrame()
        {
            ...
            lock (this)
            {
                ...
                if (Visible && (count > 1 && count < MaxSampleFrames))
                    return;
        ...
        public Color BgColor = new Color(0, 0, 0, 128);
        ...
        public void Draw(Vector2 position, int width)
        {
            ...
            // Adjust size and position based on number of bars we should draw.
            int height = 0;
            float maxTime = 0;
            ...
            Layout layout = new Layout(GraphicsDevice.Viewport);
            position = layout.Place(new Vector2(Width, height), 0, 0, Alignment.TopRight);
            position.Y += 2;
            ...
            spriteBatch.Draw(texture, rc, BgColor);
            ...
            {
                // Generate log string.
                y = startY + height + font.LineSpacing;
                logString.Length = 0;
                foreach (MarkerInfo markerInfo in markers)
                {
                    for (int i = 0; i < MaxBars; ++i)
                    {
                        if (markerInfo.Logs[i].Initialized)
                        {
                            ...
                            logString.AppendNumber(markerInfo.Logs[i].SnapAvg, 2);
                            logString.Append("ms ");
