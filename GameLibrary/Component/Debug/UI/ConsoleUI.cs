...
namespace GameLibrary.Component.Debug.UI
{
    ...
    /// </remarks>
    public class ConsoleUI : DrawableGameComponent, IDebugCommandHost
    {
        #region Constants
        ...
        List<IDebugEchoListner> listeners = new List<IDebugEchoListner>();
        ...
        public void Echo(DebugCommandMessage messageType, string text)
        {
            ...
            foreach (IDebugEchoListner listener in listeners)
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            float leftMargin = 2;// w * 0.1f;
            float topMargin = 2;// h * 0.1f;

            Rectangle rect = new Rectangle();
            rect.Width = (int) (w - 4);
            rect.Height = (int) (MaxLineCount * font.LineSpacing);
            rect.X = (int) leftMargin;
            rect.Y = (int) (h - topMargin - rect.Height);
            ...
            // Draw background
            spriteBatch.Draw(whiteTexture, rect, BgColor);
        ...
        /// </summary>
        /// <param name="dt"></param>
        private void processKeyInputs(float dt)
        {
            KeyboardState keyState = Keyboard.GetState();
