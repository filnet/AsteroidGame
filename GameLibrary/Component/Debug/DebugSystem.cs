...
using GameLibrary.Component.Debug.UI;
using Microsoft.Xna.Framework;

namespace GameLibrary.Component.Debug
{
    /// <summary>
    ...
    public class DebugSystem
    {
        ...
        /// </summary>
        public ConsoleUI DebugCommandUI { get; private set; }
        ...
        /// </summary>
        public TimeRulerUI TimeRuler { get; private set; }
...
*/
        ...
        public static DebugSystem Initialize(Game game, string debugFont)
        {
            ...
            singletonInstance.DebugCommandUI = new ConsoleUI(game);
            ...
            singletonInstance.TimeRuler = new TimeRulerUI(game);
