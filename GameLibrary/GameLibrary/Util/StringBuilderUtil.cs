...
namespace GameLibrary.Util
{
    ...
    /// One of them is the boxing occurring when using StringBuilder.AppendFormat method.
    /// Another issue is memory allocation occurring when specifying int or float for
    ...
    public static class StringBuilderUtil
    {
        ...
        {
            AppendNumber(builder, number, decimalCount, AppendNumberOptions.None);
        }
