...
namespace GameLibrary.SceneGraph
{
    class EffectFactory
    {
        ...
        {
            StockEffects.BasicEffect effect = new StockEffects.BasicEffect(gd);
            ...
            {
                "grass", "earth", "rock", "snow"
            };
            effect.TextureEnabled = true;
            effect.Texture = createTextureArray(gd, tiles);
            /*
        ...
        public static Texture2D createTextureArray(GraphicsDevice gd, String[] tiles)
        {
