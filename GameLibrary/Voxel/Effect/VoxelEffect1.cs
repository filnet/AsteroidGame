...
namespace Voxel
{
    ...
    /// </summary>
    public class VoxelEffect1 : Effect, IEffectMatrices, IEffectLights, IEffectFog
    {
        ...
        /// <summary>
        /// Creates a new VoxelEffect1 with default parameter settings.
        /// </summary>
        public VoxelEffect1(GraphicsDevice device)
            : base(AsteroidGame.AsteroidGame.Instance().Content.Load<Effect>("Effects/VoxelEffect1"))
        {
        ...
        /// <summary>
        /// Creates a new VoxelEffect1 by cloning parameter settings from an existing instance.
        /// </summary>
        protected VoxelEffect1(VoxelEffect1 cloneSource)
            : base(cloneSource)
        {
        ...
        /// <summary>
        /// Creates a clone of the current VoxelEffect1 instance.
        /// </summary>
        public override Effect Clone()
        {
            return new VoxelEffect1(this);
        }
        ...
        /// </summary>
        void CacheEffectParameters(VoxelEffect1 cloneSource)
        {
