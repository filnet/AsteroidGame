...
namespace Voxel
{
    ...
    /// </summary>
    public class VoxelSimpleEffect : Effect, IEffectMatrices, IEffectLights, IEffectFog
    {
        ...
        /// </summary>
        public VoxelSimpleEffect(GraphicsDevice device)
            : base(AsteroidGame.AsteroidGame.Instance().Content.Load<Effect>("Effects/VoxelSimpleEffect"))
        {
        ...
        /// </summary>
        protected VoxelSimpleEffect(VoxelSimpleEffect cloneSource)
            : base(cloneSource)
        {
        ...
        {
            return new VoxelSimpleEffect(this);
        }
        ...
        /// </summary>
        void CacheEffectParameters(VoxelSimpleEffect cloneSource)
        {
