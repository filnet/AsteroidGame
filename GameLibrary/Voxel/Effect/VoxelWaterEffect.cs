...
namespace Voxel
{
    ...
    /// </summary>
    public class VoxelWaterEffect : Effect, IEffectMatrices, IEffectLights, IEffectFog
    {
        ...
        EffectParameter reflectionWorldViewProjParam;

        EffectParameter refractionMapTextureParam;
        EffectParameter reflectionMapTextureParam;
        ...
        Matrix reflectionWorldViewProj;
        ...
        /// Gets or sets the projection matrix.
        /// </summary>
        public Matrix ReflectionWorldViewProj
        {
            get { return reflectionWorldViewProj; }

            set
            {
                reflectionWorldViewProj = value;
                dirtyFlags |= EffectDirtyFlags.ReflectionWorldViewProj;
            }
        }

        public Texture2D RefractionMapTexture
        {
            get { return refractionMapTextureParam.GetValueTexture2D(); }
            set { refractionMapTextureParam.SetValue(value); }
        }

        public Texture2D ReflectionMapTexture
        {
            get { return reflectionMapTextureParam.GetValueTexture2D(); }
            set { reflectionMapTextureParam.SetValue(value); }
        }
        ...
        /// </summary>
        public VoxelWaterEffect(GraphicsDevice device)
            : base(AsteroidGame.AsteroidGame.Instance().Content.Load<Effect>("Effects/VoxelWaterEffect"))
        {
        ...
        /// </summary>
        protected VoxelWaterEffect(VoxelWaterEffect cloneSource)
            : base(cloneSource)
        {
            ...
            reflectionWorldViewProjParam = cloneSource.reflectionWorldViewProjParam;
        }
        ...
        {
            return new VoxelWaterEffect(this);
        }
        ...
        /// </summary>
        void CacheEffectParameters(VoxelWaterEffect cloneSource)
        {
            ...
            reflectionWorldViewProjParam = Parameters["ReflectionWorldViewProj"];

            refractionMapTextureParam = Parameters["RefractionMapTexture"];
            reflectionMapTextureParam = Parameters["ReflectionMapTexture"];
        }
        ...
        protected override void OnApply()
        {
            ...
            if (lightingEnabled)
            {
                ...
                // 
                if ((dirtyFlags & EffectDirtyFlags.ReflectionWorldViewProj) != 0)
                {
                    reflectionWorldViewProjParam.SetValue(reflectionWorldViewProj);
                    dirtyFlags &= ~EffectDirtyFlags.ReflectionWorldViewProj;
                }
